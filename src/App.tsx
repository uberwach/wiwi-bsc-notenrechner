...
import { getGrade, calculatePflichtStats, calculateWahlAbschlussStats, calculateFinalGrade } from './utils/gradeCalculations';
...
export default function App() {
  ...
  const pflichtStats = useMemo(() => {
    return calculatePflichtStats(pflichtEntries, PFLICHT_MODULES);
  }, [pflichtEntries]);

  const wahlAbschlussStats = useMemo(() => {
    return calculateWahlAbschlussStats(wahlSlots, seminarPoints, thesisPoints, po);
  }, [wahlSlots, seminarPoints, thesisPoints, po]);

  const finalGrade = useMemo(() => {
    return calculateFinalGrade(pflichtStats, wahlAbschlussStats, po);
